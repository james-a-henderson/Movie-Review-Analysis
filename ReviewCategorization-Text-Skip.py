...
trainingSize = 50
checkNum = 500 #number of lines to process before printing a status update
...
#skip a bunch of reviews to test different data
while skipCount <= 1000000:
    try:
...
while(reviewCount < trainingSize):
    try:
        ...
        if totalRatings == 0:
            ...
            train.append((text, 'helpful'))
        else:
            train.append((text, 'unhelpful'))
